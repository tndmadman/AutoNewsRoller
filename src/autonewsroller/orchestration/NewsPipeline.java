            ...
            try{
                ...
                for(int replace:eligible){
                    ...
                    String basePrompt=chosen.prompt()==null||chosen.prompt().isBlank()
                            ...
                            : chosen.prompt();
                    String prompt=(basePrompt+", realistic editorial documentary photograph, clear central subject, natural scene depth, portrait composition with clean breathing room, no text, no logos, no watermark").replaceAll("\\s+"," ").trim();
