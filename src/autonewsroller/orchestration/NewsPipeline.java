            ...
            try{
                ...
                for(int replace:eligible){
                    ...
                    String visualSuffix="HOOK".equalsIgnoreCase(chosen.type())
                            ?", thumbnail-safe opening frame for a vertical news video, strongest concrete focal subject visible immediately on a phone screen, place the main subject in the upper-middle of the frame, keep the lower quarter visually clean for a broadcast lower-third, tight realistic editorial documentary composition, strong subject/background separation, no generic newsroom graphics, no text, no logos, no watermark"
                            :", realistic editorial documentary photograph for a vertical broadcast news package, clear central subject, natural scene depth, portrait composition, keep the lower quarter reasonably uncluttered for a news lower-third, no text, no logos, no watermark";
